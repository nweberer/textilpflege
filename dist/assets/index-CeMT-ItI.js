(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(e){if(e.ep)return;e.ep=!0;const n=t(e);fetch(e.href,n)}})();const d=document.getElementById("app"),o={home:{title:"Willkommen",content:`
      <div class="hero">
    ...
    `},produkte:{title:"Produkte",content:`
      <div class="container">
    ...
    `},unternehmen:{title:"Unternehmen",content:`
      <div class="container">
    ...
    `}};function l(i){const s=o[i];if(d.innerHTML=s.content,document.querySelectorAll(".nav-links a").forEach(t=>{t.classList.remove("active"),t.getAttribute("data-page")===i&&t.classList.add("active")}),i==="kontakt"){const t=document.getElementById("contactForm");t&&t.addEventListener("submit",a=>{a.preventDefault(),alert("Vielen Dank für Ihre Nachricht! Wir werden uns schnellstmöglich bei Ihnen melden."),t.reset()})}window.scrollTo(0,0)}function u(){const i=document.createElement("header");i.innerHTML=`
    <nav>
  ...
  `;const s=document.createElement("footer");s.innerHTML=`
    <p>&copy; ${new Date().getFullYear()} TEXTILPFLEGE GmbH AUERBACH</p>
    <p>Alle Rechte vorbehalten</p>
  `,document.body.insertBefore(i,d),document.body.appendChild(s),i.querySelector(".logo").addEventListener("click",()=>{l("home"),window.location.hash=""});const a=i.querySelector(".hamburger"),e=i.querySelector(".nav-links");a.addEventListener("click",()=>{e.classList.toggle("active")}),i.querySelectorAll(".nav-links a").forEach(r=>{r.addEventListener("click",c=>{c.preventDefault();const h=r.getAttribute("data-page");l(h),e.classList.remove("active")})});const n=window.location.hash.substring(1);n&&o[n]?l(n):l("home"),window.addEventListener("hashchange",()=>{const r=window.location.hash.substring(1);r&&o[r]&&l(r)})}u();
